          ...
          <AnimatedSection className="text-center space-y-6 max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight drop-shadow-lg leading-tight">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-white/90 max-w-3xl mx-auto drop-shadow-lg leading-relaxed">
                Η Faiacon αναλαμβάνει συνεργασίες αντιπαροχής και αξιοποίησης οικοπέδων στην Κέρκυρα με ολοκληρωμένη προσέγγιση: από την αρχική τεχνική αξιολόγηση, στο σχεδιασμό και την κατασκευή.
              </p>
          </AnimatedSection>
          ...
          <div className="max-w-4xl mx-auto">
            <AnimatedSection className="text-center space-y-6">
              ...
              <p className="text-lg sm:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
                Η αντιπαροχή είναι μια σημαντική απόφαση. Γι' αυτό δεν βιαζόμαστε. Εξετάζουμε κάθε ακίνητο προσεκτικά, λέμε ανοιχτά τι νομίζουμε και τι μπορεί να γίνει. Αν υπάρχει πραγματική δυνατότητα, αναλαμβάνουμε μια συνεργασία που έχει ουσία και νόημα.
              </p>
            </AnimatedSection>
          </div>
        </div>
            ...
            {[
              {
                ...
                description: "Βλέπουμε το ακίνητο, ρωτάμε τι σας ενδιαφέρει, εντοπίζουμε τι μπορεί να γίνει. Όχι γενικές εκτιμήσεις—ειδικά για τη δική σας περίπτωση.",
              },
              {
                icon: Building2,
                title: "Σχεδιασμός & Οργάνωση",
                description: "Αν υπάρχει δυνατότητα, σχεδιάζουμε ρεαλιστικά: ποιο έργο, που, πόσο χρόνο, ποια προοπτική.",
              },
              {
                icon: HardHat,
          ...
          <div className="max-w-4xl mx-auto">
            <AnimatedSection className="text-center mb-10 sm:mb-12">
              ...
              <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                Η Faiacon δεν περιορίζεται σε ανακαινίσεις. Δραστηριοποιούμαστε σε κάθε τομέα της τεχνικής αξιοποίησης ακινήτων στην Κέρκυρα. Γι' αυτό η αντιπαροχή εντάσσεται σε μια συνολική φιλοσοφία: σωστός σχεδιασμός, ποιοτική κατασκευή, στοχευμένες αναβαθμίσεις, και δημιουργία πραγματικής αξίας για εσάς.
              </p>
            </AnimatedSection>
