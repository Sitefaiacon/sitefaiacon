          ...
          <div className="max-w-4xl mx-auto">
            <AnimatedSection className="text-center space-y-6">
              ...
              <p className="text-lg sm:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
                Η αντιπαροχή είναι μια σημαντική απόφαση. Γι' αυτό δεν βιαζόμαστε. Εξετάζουμε κάθε ακίνητο προσεκτικά, λέμε ανοιχτά τι νομίζουμε και τι μπορεί να γίνει. Αν υπάρχει πραγματική δυνατότητα, αναλαμβάνουμε μια συνεργασία που έχει κάποια ουσία.
              </p>
            </AnimatedSection>
          </div>
        </div>
            ...
            {[
              {
                ...
                description: "Βλέπουμε το ακίνητο, ρωτάμε τι σας ενδιαφέρει, ανακαλύπτουμε τι μπορεί να γίνει. Όχι γενικά - συγκεκριμένα για τη δική σας περίπτωση.",
              },
              {
                icon: Building2,
                title: "Σχεδιασμός & Οργάνωση",
                description: "Αν υπάρχει δυνατότητα, σχεδιάζουμε ρεαλιστικά: τι έργο, που, πόσο καιρό, ποια προοπτική.",
              },
              {
                icon: HardHat,
                title: "Κατασκευή με Ευθύνη",
                description: "Αναλαμβάνουμε τα έργα με τη σοβαρότητα που τα άξιζουν. Δουλεία ποιοτική, συνεχής έλεγχος, αποτέλεσμα που συμφωνήσαμε.",
              },
              {
                icon: MessageSquare,
                title: "Συνεργασία με Διαφάνεια",
                description: "Σας λέμε ανοιχτά τι γίνεται, ποιά είναι τα επόμενα βήματα, και τι περιμένουμε. Χωρίς ασάφειες.",
              },
            ].map((item, index) => (
