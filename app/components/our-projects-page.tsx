...
const projects = [
  ...
  },
  {
    ...
    descriptionEn: "Completed exterior renovation of a residence",
    location: "Κέρκυρα",
    locationEn: "Corfu",
    image: "/images/projects/2026/traditional-renovation-exterior-finished-01.jpg",
  },
  {
    id: 44,
    title: "Ξύλινη στέγη παραδοσιακής κατοικίας — λεπτομέρεια",
    titleEn: "Traditional Residence — Timber Ceiling Detail",
    description: "Κατασκευή και διαμόρφωση ξύλινης στέγης",
    descriptionEn: "Timber roof construction and detailing",
    location: "Κέρκυρα",
    locationEn: "Corfu",
    image: "/images/projects/2026/traditional-renovation-wood-ceiling-detail-01.jpg",
  },
  {
    id: 45,
    title: "Ξύλινη στέγη παραδοσιακής κατοικίας — τελικό αποτέλεσμα",
    titleEn: "Traditional Residence — Finished Timber Ceiling",
    description: "Τελική εικόνα ξύλινης οροφής με εμφανή δοκάρια",
    descriptionEn: "Finished timber ceiling with exposed beams",
    location: "Κέρκυρα",
    locationEn: "Corfu",
    image: "/images/projects/2026/traditional-renovation-wood-ceiling-detail-02.jpg",
  },
  {
    id: 46,
    title: "Ανακαίνιση παραδοσιακής κατοικίας — εργασίες εσωτερικού χώρου",
    titleEn: "Traditional Residence Renovation — Interior Works",
    description: "Εργασίες διαμόρφωσης εσωτερικού χώρου και ξύλινης στέγης",
    descriptionEn: "Interior renovation and timber ceiling works",
    location: "Κέρκυρα",
    locationEn: "Corfu",
    image: "/images/projects/2026/traditional-renovation-wood-ceiling-progress-01.jpg",
  },
  {
    id: 47,
    title: "Ανακαίνιση παραδοσιακής κατοικίας — τελικό εσωτερικό",
    titleEn: "Traditional Residence Renovation — Finished Interior",
    description: "Ολοκληρωμένο εσωτερικό με πέτρινα στοιχεία και σύγχρονη διαμόρφωση",
    descriptionEn: "Completed interior with stone details and modern finishes",
    location: "Κέρκυρα",
    locationEn: "Corfu",
    image: "/images/projects/2026/traditional-renovation-interior-finished-01.jpg",
  },
  {
    id: 31,
            ...
            >
              ...
              <p className="text-lg text-white/80 mb-8">
                {isEnglish
                  ...
                  : "Επικοινωνήστε μαζί μας σήμερα για να συζητήσουμε πώς μπορούμε να υλοποιήσουμε το έργο σας."}
              </p>
